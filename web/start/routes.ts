...
Route.get('/api/jobs/:jobId/proc-stats/:name?', 'ApiController.job_proc_stats')
...
Route.get('/api/jobs/:id/compare/:jobId', 'ApiController.compare_job')
...
Route.get('/api/xml', 'ApiController.get_all_xml')
